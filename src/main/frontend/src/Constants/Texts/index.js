...
export const FirstTables = () => {
    return (
        <div className={'items-center text-center justify-center mx-auto'}>
            <table
                className="table-auto lg15.6:text-xl text-base lg15.6:mx-12 lg15.6:my-5 mx-10 my-3 items-center text-center justify-center border-collapse rounded-3xl border-2 border-black">
...
export const FirstTables1 = () => {
    return (
        <div className={'items-center text-center justify-center mx-auto'}>
            <table
                className="table-auto lg15.6:text-xl text-base lg15.6:mx-10 lg15.6:my-5 mx-10 my-3 items-center text-center justify-center border-collapse rounded-3xl border-2 border-black">
                <thead className="bg-gray-100">
                <tr>
                    <th className="border border-black px-4 py-2 text-left">Person ID</th>
                    <th className="border border-black px-4 py-2 text-left">Location</th>
