...
import {
    AppText, CarInfoTable,
    DamageTypeTable,
    IncidentInfoTable,
    MotiveInfoTable,
    SuspectsTable, updateBasicGame2,
    updateProgress,
    ...
    return (
        <div
            ...
            <ul className="space-y-3 lg15.6:text-xl text-base text-black">
                <li>
                    <strong>1. Location of Mishap:</strong> Try finding the <strong>location</strong>
                    of vandalism.
                </li>
                <li>
                    <strong>2. Damaged Part of the vehicle:</strong> Find which <strong>Part</strong> of the vehicle
                    has been damaged.
                </li>
                <li>
                    <strong>3. Suspicious Activity Timing:</strong> Find the <strong>Time
                </strong> when this happened.
                </li>
                <li>
                    <strong>4. Motive of commit:</strong> Find what was the <strong>Motive</strong> for the
                    crime committed.
                </li>
            </ul>
        </div>
...
const VandalismSql = () => {
            ...
            if (response.data.error) {
                ...
                if (Array.isArray(response.data.data)) {
                    ...
                    if (
                        ...
                        query.toLowerCase().includes("parking_lot = 'mall parking'") &&
                        // query.toLowerCase().includes("action = 'watching tv'") &&
                        data.some(
                            (row) =>
                                row.parking_lot?.toLowerCase().trim() === "mall parking"
                    ...
                    if (
                        ...
                        query.toLowerCase().includes("damaged_part = 'windshield'") &&
                        // query.toLowerCase().includes("witness_statement like '%knife%'") &&
                        data.some(
                            (row) =>
                                // query.toLowerCase().includes("location = 'warehouse'") &&
                                row.damaged_part?.toLowerCase().trim().includes("windshield")
    ...
    return (
        <div>
            {showDiv1 ? (
                ...
                <>
                    <div className={'w-screen h-screen bg-[#343237] grid grid-cols-3'}>
                        <div className={'flex p-2 py-64 items-end justify-center align-middle '}>
                            <Link to={'/VandalismNormalisation'}>
                                <button
                                    onClick={() => {
                                        playClickSound();
                                    }}
                ...
                <div>
                    <div className="w-screen overflow-x-hidden overflow-y-auto min-h-screen bg-[#a2e1e1] relative">
                        <NavBarInGame pageName={"VandalismSQL"}/>
                        ...
                        <p className="text-center lg15.6:text-2xl text-xl text-black">
                            Find the vandaliser among the 4 culprits.
                        </p>
                        ...
                        <div className={'p-3'}>
                            <div className="bg-white w-full p-1.5 rounded-lg shadow-md">
                                ...
                                <div className={'grid grid-cols-5 gap-3'}>
                                    <div>
                                        <h1 className={'text-black font-semibold lg15.6:text-xl text-lg '}>Relation(incident_info)</h1>
                                        <div className={'mx-auto justify-between'}>
                                            <IncidentInfoTable/>
                                        </div>
                                    </div>
                                    <div>
                                        <h1 className={'text-black font-semibold lg15.6:text-xl text-lg '}>Relation(damage_type)</h1>
                                        <div className={'mx-auto justify-between'}>
                                            <DamageTypeTable/>
                                        </div>
                                    </div>
                                    <div>
                                        <h1 className={'text-black font-semibold lg15.6:text-xl text-lg '}>Relation(suspects_vandalism)</h1>
                                        <div className={'mx-auto justify-between'}>
                                            <SuspectsTable/>
                                        </div>
                                    </div>
                                    <div>
                                        <h1 className={'text-black font-semibold lg15.6:text-xl text-lg '}>Relation(motive_info)</h1>
                                        <div className={'mx-auto justify-between'}>
                                            <MotiveInfoTable/>
                                        </div>
                                    </div>
                                    <div>
                                        <h1 className={'text-black font-semibold lg15.6:text-xl text-lg '}>Relation(car_info)</h1>
                                        <div className={'mx-auto justify-between'}>
                                            <CarInfoTable/>
                                        </div>
                                    </div>
                                        ...
                                        {culpritFound && (
                                            <div className="my-6 bg-green-100 p-6 rounded-lg shadow-md">
                                                ...
                                                <p className="text-green-700 lg15.6:text-xl text-base">You have
                                                    identified <strong>David</strong> as the
                                                    culprit.</p>
                                            </div>
                                        )}
            ...
            <HelperAtFirst show={showFinaleTest} onClose={handleClose1} value={AppText.SQLVandalism} />
