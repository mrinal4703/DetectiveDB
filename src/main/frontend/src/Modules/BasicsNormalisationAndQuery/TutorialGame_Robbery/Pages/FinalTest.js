...
const HelperAtFirst2 = ({show, onClose, value}) => {
    const [displayText, setDisplayText] = useState("");
    const [showButton, setShowButton] = useState(false);
    const [voices, setVoices] = useState([]);
    const [voicesLoaded, setVoicesLoaded] = useState(false);
...
function FinalTest() {
    ...
    const [showFinaleTest2, setShowFinaleTest2] = useState(false);
    const [showFinaleTest3, setShowFinaleTest3] = useState(false);
    const [showFinaleTest4, setShowFinaleTest4] = useState(false);
    ...
    const handleClose1 = () => {
        ...
        setShowFinaleTest2(true);
    };

    const handleClose2 = () => {
        setShowFinaleTest2(false);
        setShowFinaleTest3(true);
    };

    const handleClose3 = () => {
        setShowFinaleTest3(false);
        setShowFinaleTest4(true);
    };

    const handleClose4 = () => {
        setShowFinaleTest4(false);
    };
    ...
    return (
        <div>
            ...
            <HelperAtFirst show={showFinaleTest} onClose={handleClose1} value={AppText.WelcometoFinale} />
            <HelperAtFirst2 show={showFinaleTest2} onClose={handleClose2} value={AppText.WhatFinale} />
            <HelperAtFirst2 show={showFinaleTest3} onClose={handleClose3} value={AppText.HowFinale} />
            <HelperAtFirst show={showFinaleTest4} onClose={handleClose4} value={AppText.FinalFinale} />
