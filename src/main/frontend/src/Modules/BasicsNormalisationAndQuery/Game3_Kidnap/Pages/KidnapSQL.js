...
import {
    AppText,
    CriminalHistoryTable, Suspecttable,
    updateBasicGame3,
    updateProgress, VehicleDetailsTable, VehicleSightingsTable, WitnessReportsTable
    ...
    return (
        <div
            ...
            <ul className="space-y-3 lg15.6:text-xl text-base text-black">
                <li>
                    <strong>1. Location of Mishap and witness statement:</strong> Try finding the <strong>witness
                    statement
                </strong> of people who were present at the crime location.
                </li>
                <li>
                    <strong>2. Vehicle Spotted:</strong> Find if any <strong>Vehicle</strong> was spotted near
                    crime location.
                </li>
                <li>
                    <strong>3. Details of vehicle:</strong> Find the details of <strong>Vehicle used in Crime
                </strong> that was sen by people.
                </li>
                <li>
                    <strong>4. Suspicious Activity Timing:</strong> Find the <strong>Time
                    </strong> when this happened.
                </li>
                <li>
                    <strong>5. Criminal History:</strong> Find if any <strong>Criminal History
                    </strong> is linked with some suspects or not.
                </li>
            </ul>
        </div>
    );
        ...
        <div
            ...
            <div className="bg-white text-black p-6 rounded-lg shadow-md">
                <ul className="space-y-2 lg15.6:text-xl text-base">
                    <li>
                        Location of Mishap and witness statement:{" "}
...
const KidnapSql = () => {
    ...
    const allEvidenceCollected =
        evidence.suspiciousActivity && evidence.witnessStatement && evidence.cameraFootage && evidence.crimeTime
        && evidence.criminalHistory;
                ...
                if (Array.isArray(response.data.data)) {
                    ...
                    if (
                        ...
                        data.some(
                            (row) =>
                                // query.toLowerCase().includes("location = 'warehouse'") &&
                                row.vehicle_spotted?.toLowerCase().trim().includes("black van")
                        )
                    ) {
            ...
            {showDiv1 ? (
                ...
                <div>
                    <div className="w-screen overflow-x-hidden overflow-y-auto min-h-screen bg-[#a2e1e1] relative">
                        <NavBarInGame pageName={"KidnapSQL"}/>
                        ...
                        <p className="text-center lg15.6:text-2xl text-xl text-black">
                            Find the kidnapper among the 4 culprits.
                        </p>
                        ...
                        <div className={'p-3'}>
                            <div className="bg-white w-full p-1.5 rounded-lg shadow-md">
                                ...
                                <div className={'grid grid-cols-5 gap-3'}>
                                    <div>
                                        <h1 className={'text-black font-semibold lg15.6:text-xl text-lg '}>Relation(witness_reports)</h1>
                                        <div className={'mx-auto justify-between'}>
                                            <WitnessReportsTable/>
                                        </div>
                                    </div>
                                    <div>
                                        <h1 className={'text-black font-semibold lg15.6:text-xl text-lg '}>Relation(vehicle_sightings)</h1>
                                        <div className={'mx-auto justify-between'}>
                                            <VehicleSightingsTable/>
                                        </div>
                                    </div>
                                    <div>
                                        <h1 className={'text-black font-semibold lg15.6:text-xl text-lg '}>Relation(vehicle_details)</h1>
                                        <div className={'mx-auto justify-between'}>
                                            <VehicleDetailsTable/>
                                        </div>
                                    </div>
                                    <div>
                                        <h1 className={'text-black font-semibold lg15.6:text-xl text-lg '}>Relation(suspects_kidnap)</h1>
                                        <div className={'mx-auto justify-between'}>
                                            <Suspecttable/>
                                        </div>
                                    </div>
                                    <div>
                                        <h1 className={'text-black font-semibold lg15.6:text-xl text-lg '}>Relation(criminal_history)</h1>
                                        <div className={'mx-auto justify-between'}>
                                        ...
                                        <div className={'flex flex-col'}>
                                            ...
                                            >
                                                ...
                                                <div
                                                    ...
                                                    ${evidence.suspiciousActivity ? '#4CAF50' : '#a2e1e1'} 1deg 71deg,
                                                    #000000 71deg 73deg,
                                                    ${evidence.witnessStatement ? '#4CAF50' : '#a2e1e1'} 73deg 143deg,
                                        ...
                                        {culpritFound && (
                                            <div className="my-6 bg-green-100 p-6 rounded-lg shadow-md">
                                                ...
                                                <p className="text-green-700 lg15.6:text-xl text-base">You have
                                                    identified <strong>Jake</strong> as the
                                                    culprit.</p>
                                            </div>
                                        )}
