...
const CorrectModal = ({show}) => {
    ...
    const texts = AppText.CorrectMurderNorm;
...
const MurderNormalisation = () => {
    ...
    const handleNf2Submit = () => {
        playClickSound();
        if (validateInputs(nf2Inputs, NormalFormTestMurder.Nf2Rel)) {
            setNf2Correct(true);
        } else {
    ...
    const handleNf3Submit = () => {
        playClickSound();
        if (validateInputs(nf3Inputs, NormalFormTestMurder.Nf3Rel)) {
            updateProgress(4);
                        ...
                        <div className="lg15.6:w-[1510px] w-[1260px] mx-2.5 lg15.6:h-[690px] h-[562px] bg-white my-2 rounded-2xl p-1">
                            <div className="grid grid-cols-2 gap-3 p-1 h-full">
                                <div className='rounded-xl border-2 border-black p-2.5'>
                                    <h1 className={'text-black text-start mx-4 lg15.6:text-4xl text-3xl font-semibold my-2'}>Murder Case
                                        Relation</h1>
                                    <h1 className={'text-black text-start mx-4 lg15.6:text-3xl text-2xl mt-4 mb-3'}>Relation Name
                                        is {NormalFormTestMurder.RelationName}</h1>
                                    <h1 className={'text-gray-400 text-start mx-8 lg15.6:text-lg text-md my-2'}>Relation: {NormalFormTestMurder.Relation}</h1>
                                    <h1 className={'text-black text-start mx-2 lg15.6:text-xl text-lg my-1'}>FD
                                        Set: {NormalFormTestMurder.fdSet}</h1>
...
export default MurderNormalisation;